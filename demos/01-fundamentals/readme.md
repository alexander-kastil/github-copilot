...
| Topic                                            | Description                                                                                                  |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| **[Introduction](./01-intro/)**                 | Get started with GitHub Copilot capabilities, understand AI Assisted Coding vs. Agentic modes, subscription plans, and access sources for the latest information. |
